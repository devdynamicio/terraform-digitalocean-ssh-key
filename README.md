# Digitalocean ssh key Terraform module

Terraform Module for create [DigitalOcean ssh key](https://docs.digitalocean.com/products/droplets/how-to/add-ssh-keys/) resources.
